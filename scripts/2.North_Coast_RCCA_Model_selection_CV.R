...
k.dir <- paste(o.dir, "gam_V5", sep ='/') # kelp model results
...
# submodel 1.3 --
bm_vars[[3]] <- c(bm_vars[[1]], "mean_prob_of_rock", "log_den_STRPURAD")

# submodel 1.4 --
bm_vars[[4]] <- c(bm_vars[[1]], "mean_prob_of_rock", "log_den_STRPURAD", "log_UBR_Max")

# submodel 1.5 --
bm_vars[[5]] <- c(bm_vars[[1]], "log_den_STRPURAD", "log_UBR_Max")
...
# submodel 2.1 --
bm_vars[[6]] <- bm_vars2[[1]][bm_vars2[[1]] != "mean_prob_of_rock"]

# submodel 2.2 --
bm_vars[[7]] <- c(bm_vars[[6]], "mean_prob_of_rock")

# submodel 2.3 --
bm_vars[[8]] <- c(bm_vars[[6]], "mean_prob_of_rock", "log_den_STRPURAD")

# submodel 2.4 --
bm_vars[[9]] <- c(bm_vars[[6]], "mean_prob_of_rock", "log_den_STRPURAD", "log_UBR_Max")

# submodel 2.5 --
bm_vars[[10]] <- c(bm_vars[[6]], "log_den_STRPURAD", "log_UBR_Max")
...
# submodel 3.1 --
bm_vars[[11]] <- bm_vars3[[1]][bm_vars3[[1]] != c("mean_prob_of_rock", "log_den_STRPURAD")]

# submodel 3.2 --
bm_vars[[12]] <- c(bm_vars[[11]], "mean_prob_of_rock")

# submodel 3.3 --
bm_vars[[13]] <- c(bm_vars[[11]], "mean_prob_of_rock", "log_den_STRPURAD")

# submodel 3.4 --
bm_vars[[14]] <- c(bm_vars[[11]], "mean_prob_of_rock", "log_den_STRPURAD", "log_UBR_Max")

# submodel 3.5 --
bm_vars[[15]] <- c(bm_vars[[11]], "log_den_STRPURAD", "log_UBR_Max")
...
# get submodel variables --
bm_vars4 <- strsplit(bm_name, split = "+", fixed = T)
bm_vars4

# submodel 4.1 --
bm_vars[[16]] <- bm_vars4[[1]][bm_vars4[[1]] != "mean_prob_of_rock"]

# submodel 4.2 --
bm_vars[[17]] <- c(bm_vars[[16]], "mean_prob_of_rock")

# submodel 4.3 --
bm_vars[[18]] <- c(bm_vars[[16]], "mean_prob_of_rock", "log_den_STRPURAD")

# submodel 4.4 --
bm_vars[[19]] <- c(bm_vars[[16]], "mean_prob_of_rock", "log_den_STRPURAD", "log_UBR_Max")

# submodel 4.5 --
bm_vars[[20]] <- c(bm_vars[[16]], "log_den_STRPURAD", "log_UBR_Max")
...
gam2.2 <- gam(formula = log_den_NERLUE ~ 
...
gam4.5 <- gam(formula = log_den_NERLUE ~ 

...
kx.dir <- paste(o.dir, "gam_V7", sep ='/')
k.dir <- paste(o.dir, "gam_V8", sep ='/') # kelp model results
...
# best_mods <- read.csv(paste(kx.dir, "best_models.csv", sep ='/')) 
# head(best_mods)
# nrow(best_mods)
# 
# bm_name <- best_mods$modname[1]
# bm_vars <- strsplit(bm_name, split = "+", fixed = T)
# preds <- c(bm_vars[[1]], "log_min_dist_riv_mth")

bm_vars <- list()

#bm_vars[[1]] <- c("log_Days_16C"  , "log_UBR_Max"  , "Max_Monthly_Nitrate" , "mean_depth"  , "wh_mean" , "Mean_Monthly_NPP", "log_den_STRPURAD")

bm_vars[[1]] <- c("Mean_Monthly_Upwelling_Temp"  , "log_UBR_Max"  , "Max_Monthly_Nitrate" , "mean_depth"  , "wh_mean" , "Mean_Monthly_NPP", "log_den_STRPURAD")

#bm_vars[[3]] <- c("log_Days_16C"  , "log_UBR_Max"  , "Max_Monthly_Nitrate" , "mean_depth"  , "wh_mean" , "Mean_Monthly_NPP", "log_den_STRPURAD", "log_min_dist_riv_mth")

bm_vars[[2]] <- c("Mean_Monthly_Upwelling_Temp"  , "log_UBR_Max"  , "Max_Monthly_Nitrate" , "mean_depth"  , "wh_mean" , "Mean_Monthly_NPP", "log_den_STRPURAD", "log_min_dist_riv_mth")
...
write.csv(overall.summary, paste(o.dir, "gam_V8", "best_models_CV_summary_stats.csv", sep ='/'))
...
#ggsave(plot = p, filename = "best_models_CV_summary_stats.png", device = "png", path = paste(o.dir, "gam_V8", sep ='/'))
